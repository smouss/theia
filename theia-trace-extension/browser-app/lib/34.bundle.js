        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_1 = _a.sent();
                        this.logger.error('Failed checking a clipboard-read permission.', e_1);
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                    ...
                    case 5:
                        e_2 = _a.sent();
                        this.logger.error('Failed reading clipboard content.', e_2);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_3 = _a.sent();
                        this.logger.error('Failed checking a clipboard-write permission.', e_3);
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                    ...
                    case 5:
                        e_4 = _a.sent();
                        this.logger.error('Failed writing to the clipboard.', e_4);
                        if (browser_1.isFirefox) {
                            this.messageService.warn("Clipboard API is not available.\n                    It can be enabled by 'dom.events.testing.asyncClipboard' preference on 'about:config' page. Then reload Theia.\n                    Note, it will allow FireFox getting full access to the system clipboard.");
                        }
