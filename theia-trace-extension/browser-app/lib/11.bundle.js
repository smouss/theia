...
var EditorQuickOpenService = /** @class */ (function () {
    ...
    EditorQuickOpenService.prototype.onType = function (lookFor, acceptor) {
        return __awaiter(this, void 0, void 0, function () {
            var e_1, _a, token, editorItems, widgets, widgets_1, widgets_1_1, uri, item, e_1_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
...
(function (TextDocumentContentChangeDelta) {
    ...
    function is(arg) {
        return !!arg && typeof arg['text'] === 'string' && typeof arg['rangeLength'] === 'number' && vscode_languageserver_types_1.Range.is(arg['range']);
    }
