...
var WorkspaceService = /** @class */ (function () {
    ...
    WorkspaceService.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var wpUriString, wpStat;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.applicationName = frontend_application_config_provider_1.FrontendApplicationConfigProvider.get().applicationName;
                        return [4 /*yield*/, this.getDefaultWorkspacePath()];
                    case 1:
                        wpUriString = _a.sent();
                        return [4 /*yield*/, this.toFileStat(wpUriString)];
                    case 2:
                        wpStat = _a.sent();
                        return [4 /*yield*/, this.setWorkspace(wpStat)];
                    case 3:
                        _a.sent();
    ...
    WorkspaceService.prototype.updateRoots = function () {
        return __awaiter(this, void 0, void 0, function () {
            var e_1, _a, newRoots, rootsChanged, _loop_1, this_1, newRoots_1, newRoots_1_1, newRoot, state_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    WorkspaceService.prototype.computeRoots = function () {
        return __awaiter(this, void 0, void 0, function () {
            var e_2, _a, roots, workspaceData, _b, _c, path, valid, e_2_1;
    ...
    WorkspaceService.prototype.spliceRoots = function (start, deleteCount) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var e_3, _a, dedup, roots, toAdd, rootsToAdd_1, rootsToAdd_1_1, root, uri, toRemove, untitledWorkspace, currentData, newData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!this._workspace) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        home = _a.sent();
                        return [2 /*return*/, home && common_2.getTemporaryWorkspaceFileUri(new uri_1.default(home.uri))];
                }
            });
        });
    };
    ...
    WorkspaceService.prototype.containsSome = function (paths) {
        return __awaiter(this, void 0, void 0, function () {
            var e_4, _a, e_5, _b, _c, _d, root, uri, paths_1, paths_1_1, path, fileUri, exists, e_5_1, e_4_1;
            return __generator(this, function (_e) {
                switch (_e.label) {
    ...
    WorkspaceService.prototype.save = function (uri) {
        return __awaiter(this, void 0, void 0, function () {
            var e_6, _a, uriStr, workspaceData, _b, _c, p, preferences, stat, _d, _e, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 3:
                        ...
                        if (!this.saved) {
                            try {
                                for (_b = __values(Object.keys(this.schemaProvider.getCombinedSchema().properties)), _c = _b.next(); !_c.done; _c = _b.next()) {
                                    p = _c.value;
    ...
    WorkspaceService.prototype.watchRoots = function () {
        return __awaiter(this, void 0, void 0, function () {
            var e_7, _a, e_8, _b, rootUris, _c, _d, _e, uri, watcher, _f, _g, root;
...
var WorkspaceUriLabelProviderContribution = /** @class */ (function (_super) {
    ...
    WorkspaceUriLabelProviderContribution.prototype.canHandle = function (element) {
        if ((element instanceof uri_1.default && element.scheme === 'file' || common_1.FileStat.is(element))) {
            return 10;
        }
        return 0;
    };
    ...
    WorkspaceUriLabelProviderContribution.prototype.getStat = function (element) {
        if (common_1.FileStat.is(element)) {
            return element;
        }
    ...
    WorkspaceUriLabelProviderContribution.prototype.getIcon = function (element) {
        return __awaiter(this, void 0, void 0, function () {
            var uri, icon, stat, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (common_1.FileStat.is(element) && element.isDirectory) {
                            return [2 /*return*/, label_provider_1.FOLDER_ICON];
                        }
                        uri = this.getUri(element);
                        icon = _super.prototype.getFileIcon.call(this, uri);
                        if (!!icon) return [3 /*break*/, 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.getStat(element)];
                    case 2:
                        stat = _a.sent();
                        return [2 /*return*/, stat && stat.isDirectory ? label_provider_1.FOLDER_ICON : label_provider_1.FILE_ICON];
                    case 3:
                        err_1 = _a.sent();
                        return [2 /*return*/, label_provider_1.FILE_ICON];
                    case 4: return [2 /*return*/, icon];
                }
            });
        });
    };
    WorkspaceUriLabelProviderContribution.prototype.getName = function (element) {
        return _super.prototype.getName.call(this, this.getUri(element));
    };
    /**
    ...
    WorkspaceUriLabelProviderContribution.prototype.getLongName = function (element) {
        ...
        var relativePath = this.workspaceVariable.getWorkspaceRelativePath(uri);
        return relativePath || _super.prototype.getLongName.call(this, uri);
    };
    __decorate([
        inversify_1.inject(common_1.FileSystem),
        __metadata("design:type", Object)
    ], WorkspaceUriLabelProviderContribution.prototype, "fileSystem", void 0);
    __decorate([
