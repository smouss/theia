...
var FileNavigatorModel = /** @class */ (function (_super) {
    ...
    FileNavigatorModel.prototype.init = function () {
        ...
        this.toDispose.push(this.workspaceService.onWorkspaceLocationChanged(function () {
            _this.updateRoot();
        }));
    ...
    FileNavigatorModel.prototype.updateRoot = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.applicationState.reachedState('initialized_layout')];
                    case 1:
                        _b.sent();
                        _a = this;
    ...
    FileNavigatorModel.prototype.createRoot = function () {
        return __awaiter(this, void 0, void 0, function () {
            var e_2, _a, stat, isMulti, workspaceNode, roots, roots_1, roots_1_1, root, _b, _c, e_2_1;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
